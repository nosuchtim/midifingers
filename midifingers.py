...
class HelpPopup(QtGui.QWidget):
	...
	def helptext(self):
		...
		"To use it, you need to have a working "
		"MIDI output device.  On Windows, you can use "
		"the Microsoft GS WaveTable Synth if you don't "
		"have anything else."
		"<p>"
		...
		"of the notes, and the <b>Duration</b> value controls "
		"how long the notes will play.  "
		"If you select <b>Height-based</b> as the value "
		"for <b>Quantization</b> or <b>Duration</b>, the "
		"height of your fingers will determine those values."
		"<p>"
		"The <b>Movement Threshold</b> is the distance that "
...
class ControlPanel(QtGui.QGroupBox):
	...
	def do_help(self):
		...
		self.helpwindow.setGeometry(QtCore.QRect(100,100,400,340))
